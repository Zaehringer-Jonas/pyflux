...
class HydraHarp400(LibraryDriver):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inputChannelOffset = [-27750, 23600, 0, 0] # you can change this (in ps, like a cable delay)
    ...
    def setup(self):
        ...
        for i in range(0, 2):
            ...
            self.lib.HH_SetInputChannelOffset(ct.c_int(self.DEV_NUM), ct.c_int(i),\
                                            ct.c_int(self.inputChannelOffset[i]))
            
            
            
        self.lib.HH_SetBinning(ct.c_int(self.DEV_NUM), 
                      ct.c_int(1)) # TO DO: fix this in a clean way (1 = 8 ps resolution)
